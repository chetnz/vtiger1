...
public class CopyBillinAddrTC {

	@Test
	public void copyBillingAddrTest() throws Throwable
	{
		...
		Thread.sleep(2000);
		WebElement copyBillingAddr_radioBtn = driver.findElement(By.xpath("(//td/input[@name='cpy'])[2]"));
		boolean flag = copyBillingAddr_radioBtn.isEnabled();
		if(flag==true)
		{
